...
@File: generate_api_3.py
@Author: QI
@Date: 2021/6/4 16:39
@Description: Transformer + A_tgt(In Decoder parallel with multi_head_attn)
"""
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory, A_res, A_tgt, tgt_mask=None, memory_mask=None, tgt_key_padding_mask=None, memory_key_padding_mask=None):
        ...
        # Addressee Focus Attention + Multi-Head Attention 并行
        ...
        tgt3 = self.attn_tgt(A_tgt, memory, memory, attn_mask=memory_mask, key_padding_mask=memory_key_padding_mask)[0]
        tgt = tgt + self.dropout2(tgt2) + self.dropout_tgt(tgt3)
        tgt = self.norm2(tgt)
