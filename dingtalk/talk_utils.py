...
class Work:
    ...
    def InitMessage(self):
        ...
        j1 = {"lwp": "/reg", "headers": {"cache-header": "token app-key did ua vhost wv", "vhost": "WK",
                                         ...
                                         "app-key": "85A09F60A599F5E1867EAB915A8BB07F", "wv": "im:3,au:3,sy:4", "mid": "61880001 0"}, "body": None}
        ...
        self.sendMessage({"lwp": "/r/Adaptor/LogI/log", "headers": {"mid": makeMid()}, "body": [{"code": 2, "uid": None, "app": "ddweb", "appVer": "3.8.10", "os": "WINDOWS",
                                                                                                 "osVer": "Unknown", "manufacturer": "", "model": "", "level": 1,
                                                                                                 "message": "gmkey:stay,gokey:stayName=auth&stayTime=" + str(
                                                                                                     random.randint(100, 10000))}]})
        self.sendMessage({"lwp": "/r/Adaptor/LogI/log", "headers": {"mid": makeMid()}, "body": [{"code": 2, "uid": None, "app": "ddweb", "appVer": "3.8.10", "os": "WINDOWS",
                                                                                                 "osVer": "Unknown", "manufacturer": "", "model": "", "level": 1,
                                                                                                 "message": "gmkey:stay,gokey:stayName=login&stayTime=" + str(
        ...
        self.sendMessage({"lwp": "/r/Adaptor/LogI/log", "headers": {"mid": makeMid()}, "body": [{"code": 2, "uid": self.openId, "app": "ddweb", "appVer": "3.8.10", "os": "WINDOWS",
                                                                                                 "osVer": "Unknown", "manufacturer": "", "model": "", "level": 1,
                                                                                                 "message": "gmkey:stay,gokey:stayName=login.scanCodeLogin&stayTime=" + str(
                                                                                                     random.randint(100, 10000))}]})
        self.sendMessage({"lwp": "/r/Adaptor/LogI/log", "headers": {"mid": makeMid()}, "body": [{"code": 2, "uid": self.openId, "app": "ddweb", "appVer": "3.8.10", "os": "WINDOWS",
                                                                                                 "osVer": "Unknown", "manufacturer": "", "model": "", "level": 1,
                                                                                                 "message": "gmkey:stay,gokey:stayName=authorized&stayTime=" + str(
    ...
    def send(self, conversationId, text):
        ...
        ) * 1000000)), "conversationId": conversationId, "type": 1, "creatorType": 1, "content": {"contentType": 1, "textContent": {"text": text}, "atOpenIds": {}},
                                                                                                  "nickName": self.nick}]})
